    ...
    const convo = useRef([]);
    const greeted = useRef(localStorage.getItem("ggxly_greeted") === "1");
    ...
    if (
    lower.includes("guided responsive interactive dialogue generating") ||
    lower.startsWith("hello i am gridgxly")
    ) return;
    ...
    localStorage.setItem("ggxly_greeted", "1");
    await say(
