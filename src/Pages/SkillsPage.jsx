...
// We still keep the names for accessibility (aria-label),
// but we don't render the text under the icons.
const skillGroups = [
  {
    title: "Languages",
    skills: [
      ...
      // Using the C++ icon glyph for C / C++ / C# so we don't rely on extra imports
...
export default function SkillsPage() {
  return (
    <section className="space-y-10">
      ...
      {/* No footer here – App.jsx's global footer will show at the bottom */}
    </section>
  );
}
