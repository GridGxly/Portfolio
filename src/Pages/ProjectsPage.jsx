...
const openDetails = (e) => { e.stopPropagation(); onOpen(p); };

return (
<article
    onClick={openDetails}
    className={`group relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900/40 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(0,0,0,0.25)] ring-1 ${c.ring}`}
    >
